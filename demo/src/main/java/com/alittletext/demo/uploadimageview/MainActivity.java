package com.alittletext.demo.uploadimageview;
...
import com.alittletext.uploadimageview.R;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final GalleryConfig.Builder builder = new GalleryConfig.Builder();
        builder.imageLoader(new FrescoImageLoader(MainActivity.this))    // ImageLoader 加载框架（必填）
        ...
        uploadImageView.setUploadImageListener(new UploadImageListener() {
            ...
            public void openPhotoAlbum(UploadImageView uploadImageView, ArrayList<String> strings) {
                ...
                GalleryPick.getInstance()
                        .setGalleryConfig(builder.pathList(strings).build())
